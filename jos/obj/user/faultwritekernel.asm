...
sys_env_destroy(envid_t envid)
{
  ...
  80010d:	00 
  80010e:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  800115:	00 
  800116:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80011d:	00 
  80011e:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  800125:	e8 2c 10 00 00       	call   801156 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80019f:	00 
  8001a0:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  8001a7:	00 
  8001a8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001af:	00 
  8001b0:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  8001b7:	e8 9a 0f 00 00       	call   801156 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001f2:	00 
  8001f3:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  8001fa:	00 
  8001fb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800202:	00 
  800203:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  80020a:	e8 47 0f 00 00       	call   801156 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800245:	00 
  800246:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  80024d:	00 
  80024e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800255:	00 
  800256:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  80025d:	e8 f4 0e 00 00       	call   801156 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800298:	00 
  800299:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  8002a0:	00 
  8002a1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a8:	00 
  8002a9:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  8002b0:	e8 a1 0e 00 00       	call   801156 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002eb:	00 
  8002ec:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  8002f3:	00 
  8002f4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002fb:	00 
  8002fc:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  800303:	e8 4e 0e 00 00       	call   801156 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80033e:	00 
  80033f:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  800346:	00 
  800347:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80034e:	00 
  80034f:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  800356:	e8 fb 0d 00 00       	call   801156 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003b3:	00 
  8003b4:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  8003bb:	00 
  8003bc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003c3:	00 
  8003c4:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  8003cb:	e8 86 0d 00 00       	call   801156 <_panic>
...
devpipe_close(struct Fd *fd)
{
  ...
  800c94:	e8 7e f5 ff ff       	call   800217 <sys_page_unmap>
  ...
  800cac:	e8 66 f5 ff ff       	call   800217 <sys_page_unmap>
}
...
00800d20 <devpipe_write>:
{
  ...
  800d48:	75 41                	jne    800d8b <devpipe_write+0x6b>
			sys_yield();
  800d4a:	e8 02 f4 ff ff       	call   800151 <sys_yield>
...
00800d98 <devpipe_read>:
{
  ...
  800dc8:	75 31                	jne    800dfb <devpipe_read+0x63>
			sys_yield();
  800dca:	e8 82 f3 ff ff       	call   800151 <sys_yield>
...
00800e08 <pipe>:
{
  ...
  800e75:	e8 f6 f2 ff ff       	call   800170 <sys_page_alloc>
  ...
  800ea4:	e8 c7 f2 ff ff       	call   800170 <sys_page_alloc>
  ...
  800edd:	e8 e2 f2 ff ff       	call   8001c4 <sys_page_map>
...
00800fda <devcons_write>:
{
  ...
  80101d:	e8 81 f0 ff ff       	call   8000a3 <sys_cputs>
	for (tot = 0; tot < n; tot += m) {
...
00801036 <devcons_read>:
{
  ...
  801047:	eb 2a                	jmp    801073 <devcons_read+0x3d>
		sys_yield();
  801049:	e8 03 f1 ff ff       	call   800151 <sys_yield>
	while ((c = sys_cgetc()) == 0)
  80104e:	66 90                	xchg   %ax,%ax
  801050:	e8 6c f0 ff ff       	call   8000c1 <sys_cgetc>
...
00801075 <cputchar>:
{
  ...
  80108f:	e8 0f f0 ff ff       	call   8000a3 <sys_cputs>
}
  801094:	c9                   	leave  
  801095:	c3                   	ret    
...
008010fb <opencons>:
{
  ...
  801128:	e8 43 f0 ff ff       	call   800170 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801167:	e8 c6 ef ff ff       	call   800132 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8011d9:	e8 c5 ee ff ff       	call   8000a3 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801242:	e8 5c ee ff ff       	call   8000a3 <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801bee:	e8 93 e7 ff ff       	call   800386 <sys_ipc_recv>
    if(r < 0){
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c66:	e8 f8 e6 ff ff       	call   800363 <sys_ipc_try_send>
        if(r == 0){
  ...
  801c8b:	e8 c6 f4 ff ff       	call   801156 <_panic>
        ...
        sys_yield();
  801c90:	e8 bc e4 ff ff       	call   800151 <sys_yield>
    }
