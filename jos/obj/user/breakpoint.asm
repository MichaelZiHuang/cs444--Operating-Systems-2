...
sys_env_destroy(envid_t envid)
{
  ...
  80011c:	e8 25 10 00 00       	call   801146 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001ae:	e8 93 0f 00 00       	call   801146 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800201:	e8 40 0f 00 00       	call   801146 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800254:	e8 ed 0e 00 00       	call   801146 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002a7:	e8 9a 0e 00 00       	call   801146 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002fa:	e8 47 0e 00 00       	call   801146 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80034d:	e8 f4 0d 00 00       	call   801146 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003c2:	e8 7f 0d 00 00       	call   801146 <_panic>
...
devpipe_close(struct Fd *fd)
{
  ...
  800c84:	e8 85 f5 ff ff       	call   80020e <sys_page_unmap>
  ...
  800c9c:	e8 6d f5 ff ff       	call   80020e <sys_page_unmap>
}
...
00800d10 <devpipe_write>:
{
  ...
  800d38:	75 41                	jne    800d7b <devpipe_write+0x6b>
			sys_yield();
  800d3a:	e8 09 f4 ff ff       	call   800148 <sys_yield>
...
00800d88 <devpipe_read>:
{
  ...
  800db8:	75 31                	jne    800deb <devpipe_read+0x63>
			sys_yield();
  800dba:	e8 89 f3 ff ff       	call   800148 <sys_yield>
...
00800df8 <pipe>:
{
  ...
  800e2b:	e8 37 f3 ff ff       	call   800167 <sys_page_alloc>
  ...
  800e65:	e8 fd f2 ff ff       	call   800167 <sys_page_alloc>
  ...
  800e94:	e8 ce f2 ff ff       	call   800167 <sys_page_alloc>
  ...
  800ecd:	e8 e9 f2 ff ff       	call   8001bb <sys_page_map>
...
00800fca <devcons_write>:
{
  ...
  80100d:	e8 88 f0 ff ff       	call   80009a <sys_cputs>
	for (tot = 0; tot < n; tot += m) {
...
00801026 <devcons_read>:
{
  ...
  801037:	eb 2a                	jmp    801063 <devcons_read+0x3d>
		sys_yield();
  801039:	e8 0a f1 ff ff       	call   800148 <sys_yield>
	while ((c = sys_cgetc()) == 0)
  80103e:	66 90                	xchg   %ax,%ax
  801040:	e8 73 f0 ff ff       	call   8000b8 <sys_cgetc>
...
00801065 <cputchar>:
{
  ...
  80107f:	e8 16 f0 ff ff       	call   80009a <sys_cputs>
}
  801084:	c9                   	leave  
  801085:	c3                   	ret    
...
008010eb <opencons>:
{
  ...
  801118:	e8 4a f0 ff ff       	call   800167 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801157:	e8 cd ef ff ff       	call   800129 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8011c9:	e8 cc ee ff ff       	call   80009a <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801232:	e8 63 ee ff ff       	call   80009a <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801bde:	e8 9a e7 ff ff       	call   80037d <sys_ipc_recv>
    if(r < 0){
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c56:	e8 ff e6 ff ff       	call   80035a <sys_ipc_try_send>
        if(r == 0){
  ...
  801c7b:	e8 c6 f4 ff ff       	call   801146 <_panic>
        ...
        sys_yield();
  801c80:	e8 c3 e4 ff ff       	call   800148 <sys_yield>
    }
