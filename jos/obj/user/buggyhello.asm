...
sys_env_destroy(envid_t envid)
{
  ...
  800132:	e8 2f 10 00 00       	call   801166 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001c4:	e8 9d 0f 00 00       	call   801166 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800217:	e8 4a 0f 00 00       	call   801166 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80026a:	e8 f7 0e 00 00       	call   801166 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002bd:	e8 a4 0e 00 00       	call   801166 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800310:	e8 51 0e 00 00       	call   801166 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800363:	e8 fe 0d 00 00       	call   801166 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003d8:	e8 89 0d 00 00       	call   801166 <_panic>
...
00800adb <devfile_write>:
{
  ...
  800ae1:	c7 44 24 08 84 20 80 	movl   $0x802084,0x8(%esp)
  800ae8:	00 
  800ae9:	c7 44 24 04 90 00 00 	movl   $0x90,0x4(%esp)
  800af0:	00 
  800af1:	c7 04 24 a2 20 80 00 	movl   $0x8020a2,(%esp)
...
00800afd <devfile_read>:
{
  ...
  800b32:	c7 44 24 0c ad 20 80 	movl   $0x8020ad,0xc(%esp)
  800b39:	00 
  800b3a:	c7 44 24 08 b4 20 80 	movl   $0x8020b4,0x8(%esp)
  800b41:	00 
  800b42:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800b49:	00 
  800b4a:	c7 04 24 a2 20 80 00 	movl   $0x8020a2,(%esp)
  800b51:	e8 10 06 00 00       	call   801166 <_panic>
	assert(r <= PGSIZE);
  800b56:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800b5b:	7e 24                	jle    800b81 <devfile_read+0x84>
  800b5d:	c7 44 24 0c c9 20 80 	movl   $0x8020c9,0xc(%esp)
  800b64:	00 
  800b65:	c7 44 24 08 b4 20 80 	movl   $0x8020b4,0x8(%esp)
  800b6c:	00 
  800b6d:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800b74:	00 
  800b75:	c7 04 24 a2 20 80 00 	movl   $0x8020a2,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800c54:	c7 44 24 04 d5 20 80 	movl   $0x8020d5,0x4(%esp)
  800c5b:	00 
  ...
  800c76:	00 00 00 
	stat->st_dev = &devpipe;
  800c79:	c7 83 88 00 00 00 20 	movl   $0x803020,0x88(%ebx)
  800c80:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  800ca4:	e8 7b f5 ff ff       	call   800224 <sys_page_unmap>
  ...
  800cbc:	e8 63 f5 ff ff       	call   800224 <sys_page_unmap>
}
...
00800cc7 <_pipeisclosed>:
{
  ...
  800d1a:	c7 04 24 dc 20 80 00 	movl   $0x8020dc,(%esp)
...
00800d30 <devpipe_write>:
{
  ...
  800d58:	75 41                	jne    800d9b <devpipe_write+0x6b>
			sys_yield();
  800d5a:	e8 ff f3 ff ff       	call   80015e <sys_yield>
...
00800da8 <devpipe_read>:
{
  ...
  800dd8:	75 31                	jne    800e0b <devpipe_read+0x63>
			sys_yield();
  800dda:	e8 7f f3 ff ff       	call   80015e <sys_yield>
...
00800e18 <pipe>:
{
  ...
  800e4b:	e8 2d f3 ff ff       	call   80017d <sys_page_alloc>
  ...
  800e85:	e8 f3 f2 ff ff       	call   80017d <sys_page_alloc>
  ...
  800eb4:	e8 c4 f2 ff ff       	call   80017d <sys_page_alloc>
  ...
  800eed:	e8 df f2 ff ff       	call   8001d1 <sys_page_map>
  800ef2:	89 c3                	mov    %eax,%ebx
  800ef4:	85 c0                	test   %eax,%eax
  800ef6:	78 52                	js     800f4a <pipe+0x132>
	fd0->fd_dev_id = devpipe.dev_id;
  800ef8:	8b 15 20 30 80 00    	mov    0x803020,%edx
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800fd0:	c7 44 24 04 f4 20 80 	movl   $0x8020f4,0x4(%esp)
  800fd7:	00 
...
00800fea <devcons_write>:
{
  ...
  80102d:	e8 7e f0 ff ff       	call   8000b0 <sys_cputs>
	for (tot = 0; tot < n; tot += m) {
...
00801046 <devcons_read>:
{
  ...
  801057:	eb 2a                	jmp    801083 <devcons_read+0x3d>
		sys_yield();
  801059:	e8 00 f1 ff ff       	call   80015e <sys_yield>
	while ((c = sys_cgetc()) == 0)
  80105e:	66 90                	xchg   %ax,%ax
  801060:	e8 69 f0 ff ff       	call   8000ce <sys_cgetc>
...
00801085 <cputchar>:
{
  ...
  80109f:	e8 0c f0 ff ff       	call   8000b0 <sys_cputs>
}
  8010a4:	c9                   	leave  
  8010a5:	c3                   	ret    
...
0080110b <opencons>:
{
  ...
  801138:	e8 40 f0 ff ff       	call   80017d <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801177:	e8 c3 ef ff ff       	call   80013f <sys_getenvid>
  ...
  801192:	c7 04 24 00 21 80 00 	movl   $0x802100,(%esp)
  ...
  8011a8:	e8 51 00 00 00       	call   8011fe <vcprintf>
	cprintf("\n");
  8011ad:	c7 04 24 ed 20 80 00 	movl   $0x8020ed,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8011e9:	e8 c2 ee ff ff       	call   8000b0 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801252:	e8 59 ee ff ff       	call   8000b0 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801358:	0f be 80 23 21 80 00 	movsbl 0x802123(%eax),%eax
...
008013ee <vprintfmt>:
{
  ...
  80147e:	ff 24 8d 60 22 80 00 	jmp    *0x802260(,%ecx,4)
  ...
  80154a:	c7 44 24 08 c6 20 80 	movl   $0x8020c6,0x8(%esp)
  801551:	00 
  ...
  80157c:	b8 34 21 80 00       	mov    $0x802134,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801bfe:	e8 90 e7 ff ff       	call   800393 <sys_ipc_recv>
    if(r < 0){
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c76:	e8 f5 e6 ff ff       	call   800370 <sys_ipc_try_send>
        if(r == 0){
  ...
  801c84:	c7 44 24 08 20 24 80 	movl   $0x802420,0x8(%esp)
  801c8b:	00 
  801c8c:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
  801c93:	00 
  801c94:	c7 04 24 37 24 80 00 	movl   $0x802437,(%esp)
  801c9b:	e8 c6 f4 ff ff       	call   801166 <_panic>
        }
        sys_yield();
  801ca0:	e8 b9 e4 ff ff       	call   80015e <sys_yield>
    }
