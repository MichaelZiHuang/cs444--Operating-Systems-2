...
sys_env_destroy(envid_t envid)
{
  ...
  800109:	00 
  80010a:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  800111:	00 
  800112:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800119:	00 
  80011a:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  800121:	e8 30 10 00 00       	call   801156 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80019b:	00 
  80019c:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  8001a3:	00 
  8001a4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001ab:	00 
  8001ac:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  8001b3:	e8 9e 0f 00 00       	call   801156 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ee:	00 
  8001ef:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  8001f6:	00 
  8001f7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001fe:	00 
  8001ff:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  800206:	e8 4b 0f 00 00       	call   801156 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800241:	00 
  800242:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  800249:	00 
  80024a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800251:	00 
  800252:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  800259:	e8 f8 0e 00 00       	call   801156 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800294:	00 
  800295:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  80029c:	00 
  80029d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a4:	00 
  8002a5:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  8002ac:	e8 a5 0e 00 00       	call   801156 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002e7:	00 
  8002e8:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  8002ef:	00 
  8002f0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002f7:	00 
  8002f8:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  8002ff:	e8 52 0e 00 00       	call   801156 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80033a:	00 
  80033b:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  800342:	00 
  800343:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80034a:	00 
  80034b:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  800352:	e8 ff 0d 00 00       	call   801156 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003af:	00 
  8003b0:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  8003b7:	00 
  8003b8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003bf:	00 
  8003c0:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  8003c7:	e8 8a 0d 00 00       	call   801156 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8004b5:	ba 74 20 80 00       	mov    $0x802074,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  8004e5:	c7 04 24 f8 1f 80 00 	movl   $0x801ff8,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80073a:	c7 04 24 39 20 80 00 	movl   $0x802039,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800812:	c7 04 24 55 20 80 00 	movl   $0x802055,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8008cb:	c7 04 24 18 20 80 00 	movl   $0x802018,(%esp)
...
00800acb <devfile_write>:
{
  ...
  800ad1:	c7 44 24 08 84 20 80 	movl   $0x802084,0x8(%esp)
  800ad8:	00 
  800ad9:	c7 44 24 04 90 00 00 	movl   $0x90,0x4(%esp)
  800ae0:	00 
  800ae1:	c7 04 24 a2 20 80 00 	movl   $0x8020a2,(%esp)
...
00800aed <devfile_read>:
{
  ...
  800b22:	c7 44 24 0c ad 20 80 	movl   $0x8020ad,0xc(%esp)
  800b29:	00 
  800b2a:	c7 44 24 08 b4 20 80 	movl   $0x8020b4,0x8(%esp)
  800b31:	00 
  800b32:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800b39:	00 
  800b3a:	c7 04 24 a2 20 80 00 	movl   $0x8020a2,(%esp)
  800b41:	e8 10 06 00 00       	call   801156 <_panic>
	assert(r <= PGSIZE);
  800b46:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800b4b:	7e 24                	jle    800b71 <devfile_read+0x84>
  800b4d:	c7 44 24 0c c9 20 80 	movl   $0x8020c9,0xc(%esp)
  800b54:	00 
  800b55:	c7 44 24 08 b4 20 80 	movl   $0x8020b4,0x8(%esp)
  800b5c:	00 
  800b5d:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800b64:	00 
  800b65:	c7 04 24 a2 20 80 00 	movl   $0x8020a2,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800c44:	c7 44 24 04 d5 20 80 	movl   $0x8020d5,0x4(%esp)
  800c4b:	00 
...
devpipe_close(struct Fd *fd)
{
  ...
  800c94:	e8 7a f5 ff ff       	call   800213 <sys_page_unmap>
  ...
  800cac:	e8 62 f5 ff ff       	call   800213 <sys_page_unmap>
}
...
00800cb7 <_pipeisclosed>:
{
  ...
  800d0a:	c7 04 24 dc 20 80 00 	movl   $0x8020dc,(%esp)
...
00800d20 <devpipe_write>:
{
  ...
  800d48:	75 41                	jne    800d8b <devpipe_write+0x6b>
			sys_yield();
  800d4a:	e8 fe f3 ff ff       	call   80014d <sys_yield>
...
00800d98 <devpipe_read>:
{
  ...
  800dc8:	75 31                	jne    800dfb <devpipe_read+0x63>
			sys_yield();
  800dca:	e8 7e f3 ff ff       	call   80014d <sys_yield>
...
00800e08 <pipe>:
{
  ...
  800e3b:	e8 2c f3 ff ff       	call   80016c <sys_page_alloc>
  ...
  800e75:	e8 f2 f2 ff ff       	call   80016c <sys_page_alloc>
  ...
  800ea4:	e8 c3 f2 ff ff       	call   80016c <sys_page_alloc>
  ...
  800edd:	e8 de f2 ff ff       	call   8001c0 <sys_page_map>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800fc0:	c7 44 24 04 f4 20 80 	movl   $0x8020f4,0x4(%esp)
  800fc7:	00 
...
00800fda <devcons_write>:
{
  ...
  80101d:	e8 7d f0 ff ff       	call   80009f <sys_cputs>
	for (tot = 0; tot < n; tot += m) {
...
00801036 <devcons_read>:
{
  ...
  801047:	eb 2a                	jmp    801073 <devcons_read+0x3d>
		sys_yield();
  801049:	e8 ff f0 ff ff       	call   80014d <sys_yield>
	while ((c = sys_cgetc()) == 0)
  80104e:	66 90                	xchg   %ax,%ax
  801050:	e8 68 f0 ff ff       	call   8000bd <sys_cgetc>
...
00801075 <cputchar>:
{
  ...
  80108f:	e8 0b f0 ff ff       	call   80009f <sys_cputs>
}
  801094:	c9                   	leave  
  801095:	c3                   	ret    
...
008010fb <opencons>:
{
  ...
  801128:	e8 3f f0 ff ff       	call   80016c <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801167:	e8 c2 ef ff ff       	call   80012e <sys_getenvid>
  ...
  801182:	c7 04 24 00 21 80 00 	movl   $0x802100,(%esp)
  ...
  801198:	e8 51 00 00 00       	call   8011ee <vcprintf>
	cprintf("\n");
  80119d:	c7 04 24 ed 20 80 00 	movl   $0x8020ed,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8011d9:	e8 c1 ee ff ff       	call   80009f <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801242:	e8 58 ee ff ff       	call   80009f <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801348:	0f be 80 23 21 80 00 	movsbl 0x802123(%eax),%eax
...
008013de <vprintfmt>:
{
  ...
  80151a:	c7 44 24 08 3b 21 80 	movl   $0x80213b,0x8(%esp)
  801521:	00 
  ...
  80153a:	c7 44 24 08 c6 20 80 	movl   $0x8020c6,0x8(%esp)
  801541:	00 
  ...
  80156c:	b8 34 21 80 00       	mov    $0x802134,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801bee:	e8 8f e7 ff ff       	call   800382 <sys_ipc_recv>
    if(r < 0){
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c66:	e8 f4 e6 ff ff       	call   80035f <sys_ipc_try_send>
        if(r == 0){
  ...
  801c8b:	e8 c6 f4 ff ff       	call   801156 <_panic>
        ...
        sys_yield();
  801c90:	e8 b8 e4 ff ff       	call   80014d <sys_yield>
    }
