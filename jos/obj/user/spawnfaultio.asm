...
umain(int argc, char **argv)
{
  ...
  800075:	c7 44 24 08 e6 25 80 	movl   $0x8025e6,0x8(%esp)
  80007c:	00 
  80007d:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  800084:	00 
  800085:	c7 04 24 00 26 80 00 	movl   $0x802600,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800120:	c7 04 24 20 26 80 00 	movl   $0x802620,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002e8:	0f be 80 43 26 80 00 	movsbl 0x802643(%eax),%eax
...
0080037e <vprintfmt>:
{
  ...
  8004ba:	c7 44 24 08 5b 26 80 	movl   $0x80265b,0x8(%esp)
  8004c1:	00 
  ...
  80050c:	b8 54 26 80 00       	mov    $0x802654,%eax
