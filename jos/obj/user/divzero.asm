...
008002ee <vprintfmt>:
{
  ...
  80037e:	ff 24 8d 20 21 80 00 	jmp    *0x802120(,%ecx,4)
  ...
  80044a:	c7 44 24 08 da 23 80 	movl   $0x8023da,0x8(%esp)
  800451:	00 
  ...
  80047c:	b8 e9 1f 80 00       	mov    $0x801fe9,%eax
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800f05:	a1 0c 40 80 00       	mov    0x80400c,%eax
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80115a:	a1 0c 40 80 00       	mov    0x80400c,%eax
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801232:	a1 0c 40 80 00       	mov    0x80400c,%eax
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8012e9:	75 23                	jne    80130e <ftruncate+0x63>
		cprintf("[%08x] ftruncate %d -- bad mode\n",
			thisenv->env_id, fdnum);
  8012eb:	a1 0c 40 80 00       	mov    0x80400c,%eax
		cprintf("[%08x] ftruncate %d -- bad mode\n",
...
008014fb <devfile_write>:
{
  ...
  801501:	c7 44 24 08 98 23 80 	movl   $0x802398,0x8(%esp)
  801508:	00 
  801509:	c7 44 24 04 90 00 00 	movl   $0x90,0x4(%esp)
  801510:	00 
  801511:	c7 04 24 b6 23 80 00 	movl   $0x8023b6,(%esp)
...
0080151d <devfile_read>:
{
  ...
  801552:	c7 44 24 0c c1 23 80 	movl   $0x8023c1,0xc(%esp)
  801559:	00 
  80155a:	c7 44 24 08 c8 23 80 	movl   $0x8023c8,0x8(%esp)
  801561:	00 
  801562:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  801569:	00 
  80156a:	c7 04 24 b6 23 80 00 	movl   $0x8023b6,(%esp)
  801571:	e8 10 06 00 00       	call   801b86 <_panic>
	assert(r <= PGSIZE);
  801576:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80157b:	7e 24                	jle    8015a1 <devfile_read+0x84>
  80157d:	c7 44 24 0c dd 23 80 	movl   $0x8023dd,0xc(%esp)
  801584:	00 
  801585:	c7 44 24 08 c8 23 80 	movl   $0x8023c8,0x8(%esp)
  80158c:	00 
  80158d:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  801594:	00 
  801595:	c7 04 24 b6 23 80 00 	movl   $0x8023b6,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801674:	c7 44 24 04 e9 23 80 	movl   $0x8023e9,0x4(%esp)
  80167b:	00 
...
008016e7 <_pipeisclosed>:
{
  ...
  8016f2:	89 55 e4             	mov    %edx,-0x1c(%ebp)
		n = thisenv->env_runs;
  8016f5:	a1 0c 40 80 00       	mov    0x80400c,%eax
  ...
  801717:	0f b6 c2             	movzbl %dl,%eax
		nn = thisenv->env_runs;
  80171a:	8b 0d 0c 40 80 00    	mov    0x80400c,%ecx
  ...
  80173a:	c7 04 24 f0 23 80 00 	movl   $0x8023f0,(%esp)
  801741:	e8 20 ea ff ff       	call   800166 <cprintf>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8019f0:	c7 44 24 04 08 24 80 	movl   $0x802408,0x4(%esp)
  8019f7:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801bb2:	c7 04 24 14 24 80 00 	movl   $0x802414,(%esp)
  801bb9:	e8 a8 e5 ff ff       	call   800166 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801bbe:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801bc2:	8b 45 10             	mov    0x10(%ebp),%eax
  801bc5:	89 04 24             	mov    %eax,(%esp)
  801bc8:	e8 38 e5 ff ff       	call   800105 <vcprintf>
	cprintf("\n");
  801bcd:	c7 04 24 cc 1f 80 00 	movl   $0x801fcc,(%esp)
  801bd4:	e8 8d e5 ff ff       	call   800166 <cprintf>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801c21:	a1 0c 40 80 00       	mov    0x80400c,%eax
  ...
  801c2f:	a1 0c 40 80 00       	mov    0x80400c,%eax
  ...
  801c39:	a1 0c 40 80 00       	mov    0x80400c,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c84:	c7 44 24 08 38 24 80 	movl   $0x802438,0x8(%esp)
  801c8b:	00 
  801c8c:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
  801c93:	00 
  801c94:	c7 04 24 4f 24 80 00 	movl   $0x80244f,(%esp)
