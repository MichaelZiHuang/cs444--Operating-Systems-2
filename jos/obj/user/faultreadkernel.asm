	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 f1 1f 80 00 	movsbl 0x801ff1(%eax),%eax
...
008002de <vprintfmt>:
{
  ...
  80036e:	ff 24 8d 40 21 80 00 	jmp    *0x802140(,%ecx,4)
  ...
  80043a:	c7 44 24 08 fa 23 80 	movl   $0x8023fa,0x8(%esp)
  800441:	00 
  ...
  80046c:	b8 02 20 80 00       	mov    $0x802002,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b30:	00 
  800b31:	c7 44 24 08 ff 22 80 	movl   $0x8022ff,0x8(%esp)
  800b38:	00 
  800b39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b40:	00 
  800b41:	c7 04 24 1c 23 80 00 	movl   $0x80231c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bc2:	00 
  800bc3:	c7 44 24 08 ff 22 80 	movl   $0x8022ff,0x8(%esp)
  800bca:	00 
  800bcb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bd2:	00 
  800bd3:	c7 04 24 1c 23 80 00 	movl   $0x80231c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c15:	00 
  800c16:	c7 44 24 08 ff 22 80 	movl   $0x8022ff,0x8(%esp)
  800c1d:	00 
  800c1e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c25:	00 
  800c26:	c7 04 24 1c 23 80 00 	movl   $0x80231c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c68:	00 
  800c69:	c7 44 24 08 ff 22 80 	movl   $0x8022ff,0x8(%esp)
  800c70:	00 
  800c71:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c78:	00 
  800c79:	c7 04 24 1c 23 80 00 	movl   $0x80231c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cbb:	00 
  800cbc:	c7 44 24 08 ff 22 80 	movl   $0x8022ff,0x8(%esp)
  800cc3:	00 
  800cc4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ccb:	00 
  800ccc:	c7 04 24 1c 23 80 00 	movl   $0x80231c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d0e:	00 
  800d0f:	c7 44 24 08 ff 22 80 	movl   $0x8022ff,0x8(%esp)
  800d16:	00 
  800d17:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d1e:	00 
  800d1f:	c7 04 24 1c 23 80 00 	movl   $0x80231c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d61:	00 
  800d62:	c7 44 24 08 ff 22 80 	movl   $0x8022ff,0x8(%esp)
  800d69:	00 
  800d6a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d71:	00 
  800d72:	c7 04 24 1c 23 80 00 	movl   $0x80231c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800dd6:	00 
  800dd7:	c7 44 24 08 ff 22 80 	movl   $0x8022ff,0x8(%esp)
  800dde:	00 
  800ddf:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800de6:	00 
  800de7:	c7 04 24 1c 23 80 00 	movl   $0x80231c,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800ed5:	ba a8 23 80 00       	mov    $0x8023a8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800f05:	c7 04 24 2c 23 80 00 	movl   $0x80232c,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80115a:	c7 04 24 6d 23 80 00 	movl   $0x80236d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801232:	c7 04 24 89 23 80 00 	movl   $0x802389,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8012eb:	c7 04 24 4c 23 80 00 	movl   $0x80234c,(%esp)
...
008014eb <devfile_write>:
{
  ...
  8014f1:	c7 44 24 08 b8 23 80 	movl   $0x8023b8,0x8(%esp)
  8014f8:	00 
  8014f9:	c7 44 24 04 90 00 00 	movl   $0x90,0x4(%esp)
  801500:	00 
  801501:	c7 04 24 d6 23 80 00 	movl   $0x8023d6,(%esp)
...
0080150d <devfile_read>:
{
  ...
  801542:	c7 44 24 0c e1 23 80 	movl   $0x8023e1,0xc(%esp)
  801549:	00 
  80154a:	c7 44 24 08 e8 23 80 	movl   $0x8023e8,0x8(%esp)
  801551:	00 
  801552:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  801559:	00 
  80155a:	c7 04 24 d6 23 80 00 	movl   $0x8023d6,(%esp)
  801561:	e8 10 06 00 00       	call   801b76 <_panic>
	assert(r <= PGSIZE);
  801566:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80156b:	7e 24                	jle    801591 <devfile_read+0x84>
  80156d:	c7 44 24 0c fd 23 80 	movl   $0x8023fd,0xc(%esp)
  801574:	00 
  801575:	c7 44 24 08 e8 23 80 	movl   $0x8023e8,0x8(%esp)
  80157c:	00 
  80157d:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  801584:	00 
  801585:	c7 04 24 d6 23 80 00 	movl   $0x8023d6,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801664:	c7 44 24 04 09 24 80 	movl   $0x802409,0x4(%esp)
  80166b:	00 
...
008016d7 <_pipeisclosed>:
{
  ...
  80172a:	c7 04 24 10 24 80 00 	movl   $0x802410,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8019e0:	c7 44 24 04 28 24 80 	movl   $0x802428,0x4(%esp)
  8019e7:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801ba2:	c7 04 24 34 24 80 00 	movl   $0x802434,(%esp)
  ...
  801bb8:	e8 36 e5 ff ff       	call   8000f3 <vcprintf>
	cprintf("\n");
  801bbd:	c7 04 24 21 24 80 00 	movl   $0x802421,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c74:	c7 44 24 08 58 24 80 	movl   $0x802458,0x8(%esp)
  801c7b:	00 
  801c7c:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
  801c83:	00 
  801c84:	c7 04 24 6f 24 80 00 	movl   $0x80246f,(%esp)
